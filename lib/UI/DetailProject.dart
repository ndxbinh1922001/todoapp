...
class DetailProject extends StatefulWidget {
  ...
  final String name;
  final int color;
  const DetailProject({Key? key,required this.name,required this.color,required this.userID}): super(key: key);
                      ...
                      if (snapshot.hasData) {
                        ...
                        for (int i = 0; i < data.length; i++) {
                          if (now.millisecondsSinceEpoch <
                              DateTime.parse(data[i]['due date'].toString()).millisecondsSinceEpoch
                          && data[i]['tag']==widget.name) {
                            nowData.add(data[i]);
                          }
                        }
                        return Column(
                        ...
                        for (int i = 0; i < data.length; i++) {
                          if (tomorrow.millisecondsSinceEpoch <
                              DateTime.parse(data[i]['due date'].toString())
                                  .millisecondsSinceEpoch&& data[i]['tag']==widget.name) {
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: IconButton(
                              icon:
                              Image.asset('asset/image/Page 1 (5).png'),
                                iconSize: 30,
                              onPressed: () {
                          ...
                          Padding(
                            padding: const EdgeInsets.all(0.0),
                            child: Text('My Task',
                                style: TextStyle(color: Color(0xFF08E8E93))),
                          )
                        ],
                      ),
                      Column(
