...
class CreateNode extends StatefulWidget {
  final String userID;
  const CreateNode({Key? key,required this.userID}):super(key:key);
  CreateNodeState createState() => CreateNodeState();
}
enum menu { AddTask, AddQuickNote, AddCheckList }
class CreateNodeState extends State<CreateNode> {
  ...
  Widget build(BuildContext context) {
    return Material(child:Stack(children: [
      ...
      Padding(
          padding:
          const EdgeInsets.only(top: 150, bottom: 236, left: 20, right: 20),
